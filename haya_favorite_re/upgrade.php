...
xn_unlink(APP_PATH.'plugin/haya_favorite_re/hook/my_nav_end.htm');
xn_unlink(APP_PATH.'plugin/haya_favorite_re/hook/admin_user_delete_end.php');

// add 2018-3-8
xn_unlink(APP_PATH.'plugin/haya_favorite_re/hook/my_common_mobile_my_thread_after.htm');
xn_unlink(APP_PATH.'plugin/haya_favorite_re/hook/my_common_my_thread_after.htm');
xn_unlink(APP_PATH.'plugin/haya_favorite_re/view/htm/my_favorite.template.htm');
...
// add 2018-5-12
xn_unlink(APP_PATH.'plugin/haya_favorite_re/hook/model_thread_delete_end.php');

// add 2018-5-18
// xn_unlink(APP_PATH.'plugin/haya_favorite_re/hook/model_user__delete_end.php');
...
$haya_favorite_config = array(
	...
	"thread_show_favorite_card" => 1,
	"thread_show_favorite_users" => 1,
	"show_hot_favorite" => 0,
