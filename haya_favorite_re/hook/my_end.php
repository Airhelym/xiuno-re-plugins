...
elseif ($action == 'favorite') {
	...
	if ($method == 'GET') {
		...
		include _include(APP_PATH.'plugin/haya_favorite_re/view/htm/my_favorite.htm');
		...
		if ($action == 'create') {
			...
			ob_start();
			include _include(APP_PATH.'plugin/haya_favorite_re/view/htm/my_favorite_users.htm');	
	...
	include _include(APP_PATH.'plugin/haya_favorite_re/view/htm/my_favorites.htm');	
}
