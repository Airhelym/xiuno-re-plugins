...
if ($method == 'GET') {
	...
	include _include(APP_PATH.'plugin/haya_favorite_re/view/htm/setting.htm');
	...
	$config['thread_show_favorite_card'] = param('thread_show_favorite_card', 1);
	$config['thread_show_favorite_users'] = param('thread_show_favorite_users', 1);
	...
	message(0, jump(lang('haya_favorite_setting_success'), url('plugin-setting-haya_favorite_re')));
}
